...
>>>>>>> 6b1dd79545ea24523434aa2c22d31ab94cd14588
        ...
        <>
          <div className="bg-white  flex justify-around">
            ...
            <div className="flex flex-col justify-around pt-5 mt-14 mb-6 pl-10 w-1/2 rounded-xl">
              ...
              <ShowFilters
                filterData={sortedWorkers}
                infoFilters={filtersInfo}
                deleteFilter={delFilterWorkers}
              />
                ...
                {sortedWorkers.map((info) => {
                  return (
                    <Link href="/WorkerDetail" key={info._id}>
                      <div
                        key={info._id}
                        className="flex justify-start bg-neutral-300 p-5 mb-10 mr-5 rounded-xl duration-200 hover:scale-105"
                      >
                        <Image
                          key={info._id}
                          src={info.profilepic}
                        ...
                        <div className="pl-10 w-full flex justify-between">
                          <div className="flex flex-col justify-around">
                            ...
                            <p>
                              Profesión:{" "}
                              {info.type.map((info) => info.name).toString()}
                            </p>
                          </div>
                ...
                <Link key="a" href="/HomeEmployer/HEOffers">
                  <div className="flex justify-center bg-blue-300 mt-5 mb-5 pt-2 pb-2 pl-5 pr-5 rounded-xl hover:bg-blue-500">
                    {userData.name ? (
                      ...
                      <button onClick={handleAction} className="font-bold">
                        💼 Mis Ofertas
                      </button>
                    )}
                  </div>
