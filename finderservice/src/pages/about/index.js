        ...
        {us.map((x) => {
          return (
            <div
              className={
                x.sw
                  ? Style.container_about_container_cards
                  : Style.container_about_container_cardsA
              } key={x.name}
            >
              ...
              <div className={Style.container_about_container_cards_data}>
                ...
                <p
                  className={
                    Style.container_about_container_cards_data_paragrath
                  }
                >
                  {x.para}
                </p>
