...
export default async function handler(req, res) {
    ...
    switch (req.method) {
        ...
        try{
            ...
            if(!JobPostulationId) return res.status(404).json({error:' Job postulation not found'});
        ...
        try{
            ...
            if(!deleteJobPostulation) return res.status(404).json({error:' Job postulation not found'});
