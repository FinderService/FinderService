        ...
        <Layout>
          <div className="flex flex-row items-center justify-center h-screen overflow-y-hidden">
            ...
            <div className="flex flex-col text-white mr-8 w-[30rem]">
                <div className="border-2 border-yellow-600 bg-yellow-300 rounded-md p-3 text-yellow-700 text-xl font-semibold mb-3">
                    Para poder continual es necerario completar el formulario
                </div>
            ...
            {state.register ? (
              ...
              >
                ...
                <div className="flex items-end justify-center">
                  <button
                    type="submit"
                    className="btn-navbar w-[11rem] text-center"
                  >
